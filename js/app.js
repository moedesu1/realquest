  ...
  itemsEl.innerHTML = acceptedItems.map(q => {
    ...
    <div class="cart-item">
      ...
      <div class="cart-item-actions">
        ...
        <span>${qty}</span>
        <button onclick="updateLocalCartQty(${q.id}, 1)">+</button>
        <button class="cart-item-remove" onclick="removeLocalCart(${q.id})" title="削除"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></button>
      </div>
    </div>`;
  }).join('');
  footerEl.style.display = 'block';
